...
public class Die {
	 ...
	 * <p>
	 * pre: none<br>
	 * post: return true if the parameter is a Die object with the same number
	 * of sides as this Die and currently has the same result.
	 * 
	 ...
	 * <p>
	 * pre: none<br>
	 * post: return a String with information about the current state of this
	 * Die
	 * 
